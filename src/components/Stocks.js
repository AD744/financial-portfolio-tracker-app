...
class Stocks extends Component {
   ...
   componentDidMount() {
      ...
      axios.get(`https://financial-portfolio-a0ff5.firebaseio.com/tickers.json`)
         .then(res => {
  ...
  // componentWillUpdate() {
   ...
   postData = (e) => {
      ...
      axios.post('https://financial-portfolio-a0ff5.firebaseio.com/mystocks.json', {
      ...
      axios.delete(`https://financial-portfolio-a0ff5.firebaseio.com/tickers.json/${id}.json`);
   }
