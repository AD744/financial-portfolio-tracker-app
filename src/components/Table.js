...
axios.get(`https://financial-portfolio-a0ff5.firebaseio.com/mystocks.json`)
         .then(res => {
   ...
   handleDelete = (event) => {
      ...
      axios.delete(`https://financial-portfolio-a0ff5.firebaseio.com/mystocks.json`);

      axios.post('`https://financial-portfolio-a0ff5.firebaseio.com/tickers.json`', {
